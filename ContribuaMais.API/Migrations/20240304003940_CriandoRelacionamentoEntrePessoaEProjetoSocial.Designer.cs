...
namespace ContribuaMais.API.Migrations
{
    ...
    [Migration("20240304003940_CriandoRelacionamentoEntrePessoaEProjetoSocial")]
    partial class CriandoRelacionamentoEntrePessoaEProjetoSocial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContribuaMais.API.Models.Dados.Campanha", b =>
                {
                    ...
                    b.Property<Guid?>("ProjetoSocialId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("ProjetoSocialId");
            ...
            modelBuilder.Entity("ContribuaMais.API.Models.Dados.Infraestrutura.Contato", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ContribuaMais.API.Models.Dados.Infraestrutura.DocumentosPessoais", b =>
                {
                    ...
                    b.ToTable("DocumentosPessoais");
                });

            modelBuilder.Entity("ContribuaMais.API.Models.Dados.Infraestrutura.Endereco", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ContribuaMais.API.Models.Dados.Campanha", b =>
                {
                    b.HasOne("ContribuaMais.API.Models.Dados.ProjetoSocial", null)
                        .WithMany("Campanhas")
                        .HasForeignKey("ProjetoSocialId");
                });
            ...
            modelBuilder.Entity("ContribuaMais.API.Models.Dados.Infraestrutura.Pessoa", b =>
                {
                    ...
                    b.HasOne("ContribuaMais.API.Models.Dados.Infraestrutura.DocumentosPessoais", "DocumentosPessoais")
                        .WithMany()
                        .HasForeignKey("DocumentosPessoaisId");

                    b.HasOne("ContribuaMais.API.Models.Dados.Infraestrutura.Endereco", "Endereco")
                        .WithMany()
            ...
            modelBuilder.Entity("ContribuaMais.API.Models.Dados.ProjetoSocial", b =>
                {
                    b.HasOne("ContribuaMais.API.Models.Dados.Infraestrutura.Pessoa", "PessoaResponsavel")
                        .WithMany()
